package com.zqz.common.constants;

/**
 * @Author: zqz
 * @Description:
 * @Date: Created in 14:19 2020/10/19
 */
public class FieldConstant {


    public static final String DATA_TYPE_KEY = "沪深A股";

    public static final String DAY_KEY = "今日排行";

    public static final String JS_DATA = "{{jsName.DATA}}";
